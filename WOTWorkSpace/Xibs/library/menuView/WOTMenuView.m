...
@interface WOTMenuView()<UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation WOTMenuView


- (NSMutableArray<WOTFilterTypeModel *> *)menuArray {
    if (!_menuArray) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WOTFilterTypeModel *model = [self.dataSource menu_filterDataArray][indexPath.row];
