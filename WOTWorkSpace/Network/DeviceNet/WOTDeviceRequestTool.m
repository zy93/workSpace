...
@implementation WOTDeviceRequestTool


/**
 *  发送get请求
 *
 *  @param exStr 请求的地址（不加前面ip地址和端口号，只需要后面的，如http://123.56.197.113:8080/Service_Platform/country.do，只需要写 Service_Platform/country.do）
 *  @param param 请求的参数，拼接成字典
 */
